...
public class XlsDataReaderUtil {
    ...
    try {
        reader = new Xls_Reader("/Users/ismayatikiran/Documents/Web-Automation-FrameWork_group1/Web-Automation-FrameWork/Walgreen/Data/DataFile2.xls");
    }
    catch (Exception e){
        e.printStackTrace();
    }
     // change only sheet name in line 19
    for (int rowNum =2; rowNum <= reader.getRowCount("DataFile"); rowNum++){
