...
public class CommonAPI {
    ...
    public String browserstack_username = "ismayatikiran1";
    public String browserstack_accesskey = "H6q2VCFUri71EEHpbwqG";
...
*/
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false") String cloudEnvName,
                      @Optional("OS X") String os, @Optional("Sierra") String os_version, @Optional("chrome") String browsername,
                      @Optional("69") String browserVersion, @Optional("https://www.Amazon.com/") String url) throws Exception {
...
//          driver = new ChromeDriver();
    ...
    public WebDriver getCloudDriver(String envName, String envUsername, String envAccessKey, String os, String
            os_version, String browserName, String browserVersion) throws IOException {
...
//         driver.close();
    ...
    public CharSequence selectOptionByVisibleText(WebElement element, String value) {
    ...
    public List<String> TextFromWebElements(String locator) {
        List<WebElement> element = new ArrayList<WebElement>();
        List<String> text = new ArrayList<String>();
